...
export default function ModelPopover({
  ...
  const selectedIcon = getModelIcon(selectedModel.model);
      ...
      <PopoverTrigger asChild>
        ...
        >
          <span className='flex size-5 shrink-0 items-center justify-center overflow-hidden rounded'>
            {selectedIcon ? <img src={selectedIcon} alt='' className='size-full object-contain' /> : <Sparkles className='size-4' />}
          </span>
            ...
            return (
              ...
              >
                <span className='flex size-6 shrink-0 items-center justify-center overflow-hidden rounded-md'>
                  {icon ? <img src={icon} alt='' className='size-full object-contain' /> : <Sparkles className='text-color-main size-4' />}
                </span>
